...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2024 at 07:52 PM
...
CREATE TABLE `cart` (
  ...
  `year` int(11) NOT NULL DEFAULT 1000
...
INSERT INTO `cart` (`CartID`, `OrderID`, `MenuID`, `TableID`, `Amount`, `status`, `jsOption`, `Price`, `day`, `month`, `year`) VALUES
(1, 17, 1, 10, 1, 3, '[[{\"Description\":\"Test_1_EN\"}],[{\"Description\":\"test_1_KR\"}],[{\"Description\":\"TEST_1_CN\"}],[{\"Description\":\"TEST_1_TH\"}]]', 0, 1, 1, 1000),
(2, 17, 2, 10, 1, 1, '[[{\"Description\":\"Test_1_EN\"}],[{\"Description\":\"test_1_KR\"}],[{\"Description\":\"TEST_1_CN\"}],[{\"Description\":\"TEST_1_TH\"}]]', 0, 1, 1, 1000),
(3, 2, 1, 10, 1, 99, '[[{\"Description\":\"Test_1_EN\"}],[{\"Description\":\"test_1_KR\"}],[{\"Description\":\"TEST_1_CN\"}],[{\"Description\":\"TEST_1_TH\"}]]', 0, 1, 1, 1000),
(5, 16, 2, 15, 2, 4, '[[{\"Description\":\"Test_1_EN\"}],[{\"Description\":\"test_1_KR\"}],[{\"Description\":\"TEST_1_CN\"}],[{\"Description\":\"TEST_1_TH\"}]]', 0, 16, 3, 2024),
(6, 16, 1, 15, 2, 4, '[[{\"Description\":\"Test_1_EN\"}],[{\"Description\":\"test_1_KR\"}],[{\"Description\":\"TEST_1_CN\"}],[{\"Description\":\"TEST_1_TH\"}]]', 200, 16, 3, 2024);
...
(3, 999999, 1, 3, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'default.png');
